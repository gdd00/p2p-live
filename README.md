...
| 设置项 | 推荐值 | 说明 |
|---|---|---|
| **编码器** | x264 或 NVIDIA NVENC H.264 | FLV 容器仅支持 H.264 视频，**不可用 H.265/HEVC** |
...
**这是最常见的坑。** 如果你使用了 Sing-box、mihomo 等代理软件并开启了 TUN 模式，TUN 虚拟网卡会接管所有系统流量（包括 IPv6），导致你无法通过自己的公网 IPv6 地址连接本机服务。
